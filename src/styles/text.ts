...
import { colorBlack, colorBlue, colorGray, colorGreen, colorRed, colorWhite, colorYellow } from "./colors";
...
export const fs12BoldBlue8: TextStyle = {
  ...
  fontFamily: NunitoBold,
  fontSize: sh12,
  lineHeight: scaleHeight(10 * 1.3),
};

export const fs12BoldBlue10: TextStyle = {
  color: colorBlue._10,
  fontFamily: NunitoBold,
  fontSize: sh12,
  lineHeight: scaleHeight(12 * 1.3),
...
export const fs12RegBlue9: TextStyle = {
  color: colorBlue._9,
  fontFamily: NunitoRegular,
  fontSize: sh12,
  lineHeight: scaleHeight(12 * 1.3),
...
export const fs12RegGreen1: TextStyle = {
  color: colorGreen._1,
  fontFamily: NunitoRegular,
  fontSize: sh12,
  lineHeight: scaleHeight(12 * 1.3),
...
export const fs14BoldWhite1: TextStyle = {
  color: colorWhite._1,
  fontFamily: NunitoBold,
  fontSize: sh14,
  lineHeight: scaleHeight(14 * 1.3),
...
export const fs14RegBlue1: TextStyle = {
  color: colorBlue._1,
  fontFamily: NunitoRegular,
  fontSize: sh14,
  lineHeight: scaleHeight(14 * 1.3),
...
export const fs14SemiBoldBlue1: TextStyle = {
  color: colorBlue._1,
  fontFamily: NunitoSemiBold,
  fontSize: sh14,
  lineHeight: scaleHeight(14 * 1.3),
...
export const fs14SemiBoldBlue5: TextStyle = {
  color: colorBlue._5,
  fontFamily: NunitoSemiBold,
  fontSize: sh14,
  lineHeight: scaleHeight(14 * 1.3),
...
export const fs20BoldGray6: TextStyle = {
  color: colorGray._6,
  fontFamily: NunitoBold,
  fontSize: sh20,
  lineHeight: scaleHeight(20 * 1.4),
